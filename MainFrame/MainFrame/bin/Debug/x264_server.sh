...
VCAPS="video/x-raw-yuv,width=320,height=240,framerate=10/1"
VSOURCE="$VELEM ! $VCAPS"
...
VELEM="v4l2src"
#VELEM="videotestsrc is-live=1"
VCAPS="video/x-raw-yuv,width=320,height=240,framerate=15/1"
...
VRTPSINK="udpsink port=5005 ts-offset=$VOFFSET name=vrtpsink"
VRTCPSINK="udpsink port=5001  sync=false async=false name=vrtcpsink"
VRTCPSRC="tcpserversrc port=5005 name=vrtpsrc"
...
ARTPSINK="udpsink port=5002 ts-offset=$AOFFSET name=artpsink"
ARTCPSINK="udpsink port=5003 sync=false async=false name=artcpsink"
